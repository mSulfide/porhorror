...
export module Physic {
    ...
    export function doCirclesIntersect(circle1: Circle, circle2: Circle): boolean {
    ...
    export function doesCircleIntersectSegment(circle: Circle, pointA: TPoint, pointB: TPoint): boolean {
