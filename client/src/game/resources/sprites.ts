...
export const sprites = {
    ...
    // ITEMS
    [ESprite.horizPhotoITM]: getSprite(EImage.environment, [0, 0], [16, 16]),
    [ESprite.verticPhotoITM]: getSprite(EImage.environment, [16, 0], [16, 16]),
    [ESprite.coffeeITM]: getSprite(EImage.environment, [32, 0], [16, 16]),
    [ESprite.wateringCanITM]: getSprite(EImage.environment, [48, 0], [16, 16]),
    [ESprite.paperITM]: getSprite(EImage.environment, [64, 0], [16, 16]),
    [ESprite.cookieITM]: getSprite(EImage.environment, [0, 16], [16, 16]),
    [ESprite.gradeBookITM]: getSprite(EImage.environment, [16, 16], [16, 16]),
    // PATTERNS
    [ESprite.linoleumPAT]: getSprite(EImage.environment, [0, 0], [32, 32]),
    [ESprite.slabsPAT]: getSprite(EImage.environment, [32, 0], [32, 32]),
    // WALLS - walls
    [ESprite.allSidesWLL]: getSprite(EImage.environment, [0, 0], [8, 32]),
    [ESprite.longSidesWLL]: getSprite(EImage.environment, [8, 0], [8, 32]),
    [ESprite.threeSidesWLL]: getSprite(EImage.environment, [16, 0], [8, 32]),
    [ESprite.longSideWLL]: getSprite(EImage.environment, [24, 0], [8, 32]),
    [ESprite.cornerWLL]: getSprite(EImage.environment, [32, 0], [8, 32]),
    // WALLS - columns
    [ESprite.allSidesColumnWLL]: getSprite(EImage.environment, [0, 0], [32, 32]),
    [ESprite.cornerColumnWLL]: getSprite(EImage.environment, [32, 32], [32, 32]),
    [ESprite.threeSidesColumnWLL]: getSprite(EImage.environment, [0, 64], [32, 32]),
}